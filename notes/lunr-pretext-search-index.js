...
var ptx_lunr_docs = [
{
  "id": "sec-I-1-sols",
  "level": "1",
  "url": "sec-I-1-sols.html",
  "type": "Worksheet",
  "number": "",
  "title": "Introduction and <span class=\"process-math\">\\(\\S I.1\\text{:}\\)<\/span> Sets and Elements",
  "body": " Introduction and : Sets and Elements    Why? Traditional Calculus vs. Math 156     Traditional calculus courses typically emphasize algebra\/trigonometry, an introduction to limits (infinity and infinitesimals), and derivatives and integrals (tools for measuring change). Ultimately the goal is to be able to approach differential equations, which help us model physical applications.  In math 156, we emphasize logic\/relations, functions, derivatives and integrals (with applications), and sequences\/series. The goal is to emphasize tools that help us program and compute.     Motivation: Sets and Elements       Sets are one of the most basic structures that we use in mathematics, and they're used often in building other objects and in writing algorithms.     Definition: Set   A set is    a collection of objects, called elements .      The following exercises will introduce the important notation (i.e., symbols) used to to communicate sets, and the various ways we can build them.   Activity: Sets and Elements   The following are examples of sets. Use them to answer the questions.                                     Do you think any sets are the same? Explain your reasoning.    Sets and are the same, and sets and are the same. Two sets are equal if they contain the same elements (order and repetition are disregarded).      The following express TRUE statements. Write out what you think they mean using an English sentence.                             The number is an element of the set .    The number is not an element of the set .    The number of elements (or cardinality ) of sets and is .    The set is an element of the set .         What questions or observations do you have about sets so far?        Activity: Set Builder Notation   For large or more complicated sets, it's not always convenient (or possible) to write out every element of the set as we did previously. To communicate these sets, we can use set builder notation . The following are examples of sets using set builder notation. Use them to answer the questions.                                It is true that . Write an English sentence that describes set builder notation for .    The set is all elements in such that is greater than two. The symbol \" \" reads \"such that\". It is also common to use a colon (\" \") to indicate the same thing. The left hand side of set builder notation indicates a variable for elements in the set, while the right hand side (called the predicate ) indicates a condition that must be met to be in the set.      For , write out the sets explicitly, or describe what they are in more common language. Are any sets equal?             is the set of all positive even integers.     is also the set of all positive even integers.              Determine if the following are TRUE or FALSE.                   TRUE    FALSE. The left hand side indicate the cardinality of a set, which should be a number, not a set. To make this true, replace with .           Some Special Sets   The following are commonly used sets that have special notation:                              (Integers)     (Natural Numbers)     (Rational Numbers)     (Real Numbers)        Practice: True or False?                                          FALSE    TRUE    FALSE    TRUE    TRUE    FALSE        "
},
{
  "id": "xr-why-sols",
  "level": "2",
  "url": "sec-I-1-sols.html#xr-why-sols",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "Why? Traditional Calculus vs. Math 156.",
  "body": " Why? Traditional Calculus vs. Math 156     Traditional calculus courses typically emphasize algebra\/trigonometry, an introduction to limits (infinity and infinitesimals), and derivatives and integrals (tools for measuring change). Ultimately the goal is to be able to approach differential equations, which help us model physical applications.  In math 156, we emphasize logic\/relations, functions, derivatives and integrals (with applications), and sequences\/series. The goal is to emphasize tools that help us program and compute.   "
},
{
  "id": "xr-motivation-sols",
  "level": "2",
  "url": "sec-I-1-sols.html#xr-motivation-sols",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "Motivation: Sets and Elements.",
  "body": " Motivation: Sets and Elements       Sets are one of the most basic structures that we use in mathematics, and they're used often in building other objects and in writing algorithms.   "
},
{
  "id": "xr-def-set-sols",
  "level": "2",
  "url": "sec-I-1-sols.html#xr-def-set-sols",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "Definition: Set.",
  "body": " Definition: Set   A set is    a collection of objects, called elements .   "
},
{
  "id": "xr-act1-sols",
  "level": "2",
  "url": "sec-I-1-sols.html#xr-act1-sols",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "Activity: Sets and Elements.",
  "body": " Activity: Sets and Elements   The following are examples of sets. Use them to answer the questions.                                     Do you think any sets are the same? Explain your reasoning.    Sets and are the same, and sets and are the same. Two sets are equal if they contain the same elements (order and repetition are disregarded).      The following express TRUE statements. Write out what you think they mean using an English sentence.                             The number is an element of the set .    The number is not an element of the set .    The number of elements (or cardinality ) of sets and is .    The set is an element of the set .         What questions or observations do you have about sets so far?    "
},
{
  "id": "sec-I-1-sols-4-1",
  "level": "2",
  "url": "sec-I-1-sols.html#sec-I-1-sols-4-1",
  "type": "Worksheet Exercise",
  "number": "5",
  "title": "Activity: Set Builder Notation.",
  "body": " Activity: Set Builder Notation   For large or more complicated sets, it's not always convenient (or possible) to write out every element of the set as we did previously. To communicate these sets, we can use set builder notation . The following are examples of sets using set builder notation. Use them to answer the questions.                                It is true that . Write an English sentence that describes set builder notation for .    The set is all elements in such that is greater than two. The symbol \" \" reads \"such that\". It is also common to use a colon (\" \") to indicate the same thing. The left hand side of set builder notation indicates a variable for elements in the set, while the right hand side (called the predicate ) indicates a condition that must be met to be in the set.      For , write out the sets explicitly, or describe what they are in more common language. Are any sets equal?             is the set of all positive even integers.     is also the set of all positive even integers.              Determine if the following are TRUE or FALSE.                   TRUE    FALSE. The left hand side indicate the cardinality of a set, which should be a number, not a set. To make this true, replace with .       "
},
{
  "id": "sec-I-1-sols-5-1",
  "level": "2",
  "url": "sec-I-1-sols.html#sec-I-1-sols-5-1",
  "type": "Worksheet Exercise",
  "number": "6",
  "title": "Some Special Sets.",
  "body": " Some Special Sets   The following are commonly used sets that have special notation:                              (Integers)     (Natural Numbers)     (Rational Numbers)     (Real Numbers)      "
},
{
  "id": "sec-I-1-sols-5-2",
  "level": "2",
  "url": "sec-I-1-sols.html#sec-I-1-sols-5-2",
  "type": "Worksheet Exercise",
  "number": "7",
...
},
{
  "id": "sec-IV-7-sols",
  "level": "1",
  "url": "sec-IV-7-sols.html",
  "type": "Worksheet",
  "number": "",
  "title": "<span class=\"process-math\">\\(\\S IV.7\\text{:}\\)<\/span> Geometric Series",
  "body": " : Geometric Series    Adapted from \"Active Learning Materials for Second Semester Calculus\", CU Boulder     Consider coloring in a square using the following step-by-step process. For the first step, we draw a line vertically down the middle of the square and color the right half:  Square getting colored.    Since the square has area 1, the area of the shaded region is 1\/2. For the next step, we draw a horizontal line through the remaining space and color in the top quarter:  Square getting colored again.  At this point, the shaded region has area . We continue this process, at each step coloring half of the remaining space.    Draw the square after three steps. What is the area of the shaded region? Write this as both an expanded sum, and as a single fraction.     Square colored after three steps  Area is .      Draw the square after four steps. What is the area of the shaded region? Write this as both an expanded sum, and as a single fraction.      Square colored after four steps  Area is .      Draw the square after five steps. What is the area of the shaded region? Write this as both an expanded sum, and as a single fraction.      Square colored after five steps  Area is .         Now, let's think about the area after steps, where is an arbitrary number.     Write down a sum that expresses the area after steps. Write it in both expanded form and in sigma-notation.           In the previous problem, you may have noticed a pattern in your final answers. Use this to guess a simple formula for the area after steps (in other words, simplify so your answer is no longer a sum).           Based on this formula, what can you infer about the area of the shaded region as tends toward infinity? Does this make geometric sense? Why or why not?    The area approaches 1 as goes to infinity. This makes sense, because the square has area 1, and the shaded region is always contained inside the square. The non-shaded region gets cut in half each time, so the shaded area should approach 1.         Now let’s talk about general geometric sequences and series. A geometric sequence is defined by an initial term  and constant ratio  , and looks like this: Partial geometric sums are just the partial sums of geometric sequences. That is, sums of the form Infinite geometric sums, on the other hand, are the limits of the partial sums (whenever these limits exist), and look like this:      In a previous problem, the areas that you calculated were geometric sums with a specific initial term and constant ratio. What was the initial term in these sums? The constant ratio ?           In a previous problem, we came up with a simplified expression for the area of the shaded region after steps. We will generalize this expression. Let and be arbitrary numbers with .  Using the original definition of , expand and then simplify . (Hint: Group like terms. Most of them should cancel.)           If you did the above calculation carefully, you should get an answer similar to . Solve this equation to come up with a simple formula for . Check that this formula agrees with your formula from the first problem.              Recall that the value of a series is defined to be the limit of its partial sums, so that      Based on your formula for , what can you say about the convergence or divergence of ? Does it depend on ? Does it depend on ? For what values of does the series converge? For what values does it diverge?    It does not depend on , but does depend on . The series converges for . It diverges for .      Using your formula for , take limits to come up with a formula for the value of the sum of a general infinite geometric series. Check that this formula agrees with the area of the square in the very first problem.     , provided          Now that we know how to calculate finite and infinite geometric sums, let's get some practice with a few examples.                                                                Diverges        "
},
{
  "id": "sec-IV-7-sols-2-2",
  "level": "2",
  "url": "sec-IV-7-sols.html#sec-IV-7-sols-2-2",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "",
  "body": "  Consider coloring in a square using the following step-by-step process. For the first step, we draw a line vertically down the middle of the square and color the right half:  Square getting colored.    Since the square has area 1, the area of the shaded region is 1\/2. For the next step, we draw a horizontal line through the remaining space and color in the top quarter:  Square getting colored again.  At this point, the shaded region has area . We continue this process, at each step coloring half of the remaining space.    Draw the square after three steps. What is the area of the shaded region? Write this as both an expanded sum, and as a single fraction.     Square colored after three steps  Area is .      Draw the square after four steps. What is the area of the shaded region? Write this as both an expanded sum, and as a single fraction.      Square colored after four steps  Area is .      Draw the square after five steps. What is the area of the shaded region? Write this as both an expanded sum, and as a single fraction.      Square colored after five steps  Area is .    "
},
{
  "id": "sec-IV-7-sols-3-1",
  "level": "2",
  "url": "sec-IV-7-sols.html#sec-IV-7-sols-3-1",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "",
  "body": "  Now, let's think about the area after steps, where is an arbitrary number.     Write down a sum that expresses the area after steps. Write it in both expanded form and in sigma-notation.           In the previous problem, you may have noticed a pattern in your final answers. Use this to guess a simple formula for the area after steps (in other words, simplify so your answer is no longer a sum).           Based on this formula, what can you infer about the area of the shaded region as tends toward infinity? Does this make geometric sense? Why or why not?    The area approaches 1 as goes to infinity. This makes sense, because the square has area 1, and the shaded region is always contained inside the square. The non-shaded region gets cut in half each time, so the shaded area should approach 1.    "
},
{
  "id": "sec-IV-7-sols-4-1",
  "level": "2",
  "url": "sec-IV-7-sols.html#sec-IV-7-sols-4-1",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "",
...
{
  "id": "sec-IV-7-sols-5-1",
  "level": "2",
  "url": "sec-IV-7-sols.html#sec-IV-7-sols-5-1",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "",
  "body": "  Recall that the value of a series is defined to be the limit of its partial sums, so that      Based on your formula for , what can you say about the convergence or divergence of ? Does it depend on ? Does it depend on ? For what values of does the series converge? For what values does it diverge?    It does not depend on , but does depend on . The series converges for . It diverges for .      Using your formula for , take limits to come up with a formula for the value of the sum of a general infinite geometric series. Check that this formula agrees with the area of the square in the very first problem.     , provided     "
},
{
  "id": "sec-IV-7-sols-6-1",
  "level": "2",
  "url": "sec-IV-7-sols.html#sec-IV-7-sols-6-1",
  "type": "Worksheet Exercise",
  "number": "5",
  "title": "",
...
},
{
  "id": "sec-V-8-sols",
  "level": "1",
  "url": "sec-V-8-sols.html",
  "type": "Worksheet",
  "number": "",
  "title": "<span class=\"process-math\">\\(\\S V.8\\text{:}\\)<\/span> Derivatives of Common Functions",
  "body": " : Derivatives of Common Functions    Motivation: Derivatives of Common Functions       We'd like to know the derivatives of more (elementary) functions; namely, we'd like to know      Activity: Derivative of Sine   Consider the function , which is graphed in Figure below. Note carefully that the grid in the diagram does not have boxes that are , but rather approximately , as the horizontal scale of the grid is units per box.   At left, the graph of .   The graph of sine of x along with blank axes for sketching its derivative function.       At each of , use a straightedge to sketch an accurate tangent line to .    Use the provided grid to estimate the slope of the tangent line you drew at each point. Pay careful attention to the scale of the grid.    Use the limit definition of the derivative to estimate by using small values of , and compare the result to your visual estimate for the slope of the tangent line to at in (b). Using periodicity, what does this result suggest about ? about ?    Based on your work in (a), (b), and (c), sketch an accurate graph of on the axes adjacent to the graph of .    What familiar function do you think is the derivative of ?          See notes from class.    Reading left to right from with stepsize , the respective slopes of tangent lines appear to be .    From the limit definition, Because we cannot simplify the fraction any further algebraically, we estimate the value of the limit using small values of . Doing so, it appears that , and thus . This matches the estimate generated visually by sketching the tangent line at . Finally, by the periodicity of the sine function, we expect the value of the derivative at 0 to match the derivative value at and .    See notes from class.    It appears that .          Activity: Derivative of Cosine   Consider the function , which is graphed in Figure below. Note carefully that the grid in the diagram does not have boxes that are , but rather approximately , as the horizontal scale of the grid is units per box.   At left, the graph of .   The graph of the cosine function along with blank axes for sketching its derivative function.       At each of , use a straightedge to sketch an accurate tangent line to .    Use the provided grid to estimate the slope of the tangent line you drew at each point. Again, note the scale of the axes and grid.    Use the limit definition of the derivative to estimate by using small values of , and compare the result to your visual estimate for the slope of the tangent line to at in (b). Using periodicity, what does this result suggest about ? can symmetry on the graph help you estimate other slopes easily?    Based on your work in (a), (b), and (c), sketch an accurate graph of on the axes adjacent to the graph of .    What familiar function do you think is the derivative of ?          See notes from class.    Reading left to right from with stepsize , the respective slopes of tangent lines appear to be .    From the limit definition, Because we cannot simplify the fraction any further algebraically, we estimate the value of the limit using small values of . Doing so, it appears that , and thus . This matches the estimate generated visually by sketching the tangent line at . Finally, by the periodicity of the sine function, we expect the value of the derivative at to match the derivative value at .    See notes from class.    It appears that .          Activity: Derivatives of and   Use the graphs of (left) and (right) to answer the following questions.    Graph of e to the x    Graph of natural log of x       On each graph, sketch the tangent lines that represent the values , and . Then use the limit definition and technology to estimate the slope of each tangent line.    See notes from class.      On each graph, sketch a rough graph of and .    See notes from class.      Use your responses to the previous parts to hypothesize equations for and .    We see that and .        Practice: Computing Derivatives   Compute derivative functions of the following functions.                                           "
},
{
  "id": "sec-V-8-sols-2-1",
  "level": "2",
  "url": "sec-V-8-sols.html#sec-V-8-sols-2-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "Motivation: Derivatives of Common Functions.",
  "body": " Motivation: Derivatives of Common Functions       We'd like to know the derivatives of more (elementary) functions; namely, we'd like to know    "
},
{
  "id": "sec-V-8-sols-2-2",
  "level": "2",
  "url": "sec-V-8-sols.html#sec-V-8-sols-2-2",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "Activity: Derivative of Sine.",
  "body": " Activity: Derivative of Sine   Consider the function , which is graphed in Figure below. Note carefully that the grid in the diagram does not have boxes that are , but rather approximately , as the horizontal scale of the grid is units per box.   At left, the graph of .   The graph of sine of x along with blank axes for sketching its derivative function.       At each of , use a straightedge to sketch an accurate tangent line to .    Use the provided grid to estimate the slope of the tangent line you drew at each point. Pay careful attention to the scale of the grid.    Use the limit definition of the derivative to estimate by using small values of , and compare the result to your visual estimate for the slope of the tangent line to at in (b). Using periodicity, what does this result suggest about ? about ?    Based on your work in (a), (b), and (c), sketch an accurate graph of on the axes adjacent to the graph of .    What familiar function do you think is the derivative of ?          See notes from class.    Reading left to right from with stepsize , the respective slopes of tangent lines appear to be .    From the limit definition, Because we cannot simplify the fraction any further algebraically, we estimate the value of the limit using small values of . Doing so, it appears that , and thus . This matches the estimate generated visually by sketching the tangent line at . Finally, by the periodicity of the sine function, we expect the value of the derivative at 0 to match the derivative value at and .    See notes from class.    It appears that .      "
},
{
  "id": "sec-V-8-sols-3-1",
  "level": "2",
  "url": "sec-V-8-sols.html#sec-V-8-sols-3-1",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "Activity: Derivative of Cosine.",
  "body": " Activity: Derivative of Cosine   Consider the function , which is graphed in Figure below. Note carefully that the grid in the diagram does not have boxes that are , but rather approximately , as the horizontal scale of the grid is units per box.   At left, the graph of .   The graph of the cosine function along with blank axes for sketching its derivative function.       At each of , use a straightedge to sketch an accurate tangent line to .    Use the provided grid to estimate the slope of the tangent line you drew at each point. Again, note the scale of the axes and grid.    Use the limit definition of the derivative to estimate by using small values of , and compare the result to your visual estimate for the slope of the tangent line to at in (b). Using periodicity, what does this result suggest about ? can symmetry on the graph help you estimate other slopes easily?    Based on your work in (a), (b), and (c), sketch an accurate graph of on the axes adjacent to the graph of .    What familiar function do you think is the derivative of ?          See notes from class.    Reading left to right from with stepsize , the respective slopes of tangent lines appear to be .    From the limit definition, Because we cannot simplify the fraction any further algebraically, we estimate the value of the limit using small values of . Doing so, it appears that , and thus . This matches the estimate generated visually by sketching the tangent line at . Finally, by the periodicity of the sine function, we expect the value of the derivative at to match the derivative value at .    See notes from class.    It appears that .      "
},
{
  "id": "sec-V-8-sols-4-1",
  "level": "2",
  "url": "sec-V-8-sols.html#sec-V-8-sols-4-1",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "Activity: Derivatives of <span class=\"process-math\">\\(e^x\\)<\/span> and <span class=\"process-math\">\\(\\ln(x)\\)<\/span>.",
  "body": " Activity: Derivatives of and   Use the graphs of (left) and (right) to answer the following questions.    Graph of e to the x    Graph of natural log of x       On each graph, sketch the tangent lines that represent the values , and . Then use the limit definition and technology to estimate the slope of each tangent line.    See notes from class.      On each graph, sketch a rough graph of and .    See notes from class.      Use your responses to the previous parts to hypothesize equations for and .    We see that and .    "
},
{
  "id": "sec-V-8-sols-5-1",
  "level": "2",
  "url": "sec-V-8-sols.html#sec-V-8-sols-5-1",
  "type": "Worksheet Exercise",
  "number": "5",
...
},
{
  "id": "sec-VII-2-sols",
  "level": "1",
  "url": "sec-VII-2-sols.html",
  "type": "Worksheet",
  "number": "",
  "title": "<span class=\"process-math\">\\(\\S VII.2\\text{:}\\)<\/span> Taylor Series",
  "body": " : Taylor Series    Motivation: Taylor Series       We've seen that Taylor polynomials can approximate functions well, and in general, the higher the degree, the better the approximation. This motivates the concept of a Taylor series .     Definition: Taylor Series   Given a function , the Taylor series of centered at is       Note that this is a function! That is, if you change the input you get a new series. Our big question earlier with series was \"Does it converge?\". may converge for some -values but not others.       Convergence of Taylor Series   Let be a Taylor series. Then one of the following hold:        converges but diverges for all other .    There exists such that converges if , and diverges if .     converges for all .   The value referenced above is called the radius of convergence for .       Practice: Taylor Series of Common Functions   Let's compute the Taylor series of some common functions.                         ,      ,      ,      Note that with very few exceptions, if has Taylor series , then for all within the radius of convergence. Specifically for our functions above,    for all      for all      for           Properties of Taylor Series   We can combine Taylor series of functions in meaningful ways to get Taylor series of new functions. Let and .                          Example: A new Taylor series   We know .    So , with .       Practice: New Taylor series   Let's find the Taylor series for , given that we know .     Write the Taylor series for using composition.           Write the Taylor series for .           Write the Taylor series for .           Example: New Taylor series        Note also that , and . Since both and are when , this suggests that , and .       Application: Euler's Formula   One very useful application of Taylor series is that it helps us derive Euler's formula: .    See notes from class, or your textbook .     "
},
{
  "id": "sec-VII-2-sols-2-1",
  "level": "2",
  "url": "sec-VII-2-sols.html#sec-VII-2-sols-2-1",
  "type": "Worksheet Exercise",
  "number": "1",
  "title": "Motivation: Taylor Series.",
  "body": " Motivation: Taylor Series       We've seen that Taylor polynomials can approximate functions well, and in general, the higher the degree, the better the approximation. This motivates the concept of a Taylor series .   "
},
{
  "id": "sec-VII-2-sols-2-2",
  "level": "2",
  "url": "sec-VII-2-sols.html#sec-VII-2-sols-2-2",
  "type": "Worksheet Exercise",
  "number": "2",
  "title": "Definition: Taylor Series.",
  "body": " Definition: Taylor Series   Given a function , the Taylor series of centered at is       Note that this is a function! That is, if you change the input you get a new series. Our big question earlier with series was \"Does it converge?\". may converge for some -values but not others.   "
},
{
  "id": "sec-VII-2-sols-3-1",
  "level": "2",
  "url": "sec-VII-2-sols.html#sec-VII-2-sols-3-1",
  "type": "Worksheet Exercise",
  "number": "3",
  "title": "Convergence of Taylor Series.",
  "body": " Convergence of Taylor Series   Let be a Taylor series. Then one of the following hold:        converges but diverges for all other .    There exists such that converges if , and diverges if .     converges for all .   The value referenced above is called the radius of convergence for .   "
},
{
  "id": "sec-VII-2-sols-4-1",
  "level": "2",
  "url": "sec-VII-2-sols.html#sec-VII-2-sols-4-1",
  "type": "Worksheet Exercise",
  "number": "4",
  "title": "Practice: Taylor Series of Common Functions.",
  "body": " Practice: Taylor Series of Common Functions   Let's compute the Taylor series of some common functions.                         ,      ,      ,      Note that with very few exceptions, if has Taylor series , then for all within the radius of convergence. Specifically for our functions above,    for all      for all      for       "
},
{
  "id": "sec-VII-2-sols-5-1",
  "level": "2",
  "url": "sec-VII-2-sols.html#sec-VII-2-sols-5-1",
  "type": "Worksheet Exercise",
  "number": "5",
...
{
  "id": "sec-VII-2-sols-5-2",
  "level": "2",
  "url": "sec-VII-2-sols.html#sec-VII-2-sols-5-2",
  "type": "Worksheet Exercise",
  "number": "6",
  "title": "Example: A new Taylor series.",
  "body": " Example: A new Taylor series   We know .    So , with .   "
},
{
  "id": "sec-VII-2-sols-6-1",
  "level": "2",
  "url": "sec-VII-2-sols.html#sec-VII-2-sols-6-1",
  "type": "Worksheet Exercise",
  "number": "7",
...
{
  "id": "sec-VII-2-sols-6-2",
  "level": "2",
  "url": "sec-VII-2-sols.html#sec-VII-2-sols-6-2",
  "type": "Worksheet Exercise",
  "number": "8",
  "title": "Example: New Taylor series.",
  "body": " Example: New Taylor series        Note also that , and . Since both and are when , this suggests that , and .   "
},
{
  "id": "sec-VII-2-sols-7-1",
  "level": "2",
  "url": "sec-VII-2-sols.html#sec-VII-2-sols-7-1",
  "type": "Worksheet Exercise",
  "number": "9",
